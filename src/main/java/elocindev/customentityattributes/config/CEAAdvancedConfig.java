...
public class CEAAdvancedConfig {
    ...
    @Comment("  affected_difficulties : A List of difficulties to affect. For example: easy (to affect easy difficulty) or (hard|hardcore) (to affect only to specific difficulties)")
    ...
    @Comment("  hardcore        :   Hardcore difficulty")
